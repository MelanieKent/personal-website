...
const Hero = () => {
    return (
        <div className='text-white bg-gradient-to-b from-[#111118] to-[#393476]'>
            <div id='about' className='max-w-[800px] mt-[-96px] w-full h-screen min-h-[700px] mx-auto text-center flex flex-col justify-center pt-12'>
                ...
                <p className='sm:text-2xl text-md font-light pt-4 text-[#00d8a4]'> 
                    // B.Sc computer science candidate @ UBC :)
                </p>
